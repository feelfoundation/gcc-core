...
class UnInstallCommand extends base_1.default {
    async run() {
        ...
        try {
            ...
            if (!instance) {
                this.log(`Feel Core instance: ${name} doesn't exists, Please install using feel core:install`);
                return;
            }
            ...
            const tasks = new listr_1.default([
                {
                    title: `Uninstall Feel Core ${network} instance Installed as ${name}`,
                    task: async () => {
...
UnInstallCommand.description = 'Uninstall an instance of Feel Core.';
