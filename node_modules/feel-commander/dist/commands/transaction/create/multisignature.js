...
const processInputs = (lifetime, minimum, keysgroup) => ({ passphrase, secondPassphrase }) => feel_transactions_1.registerMultisignature({
    passphrase,
    secondPassphrase,
    keysgroup,
    lifetime,
...
class MultisignatureCommand extends base_1.default {
    async run() {
        ...
        feel_transactions_1.utils.validatePublicKeys(keysgroup);
