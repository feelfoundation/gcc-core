...
class FeelNewRelic {
	 ...
	 * @param {string} options.rootPath - Root path to the feel
	 */
 ...
 * @return {FeelNewRelic}
 */
module.exports = function newrelicFeelGenerator(newrelic, options) {
	return new FeelNewRelic(newrelic, options);
};
