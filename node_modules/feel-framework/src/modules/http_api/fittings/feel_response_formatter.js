...
const debug = require('debug')('swagger:feel:response_formatter');
 ...
 * @returns {function} {@link api.fittings.feel_response_formatter}
...
module.exports = function create() {
	 ...
	 * Description of the function.
	 *
	 * @func feel_response_formatter
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} next
	 * @todo Add description for the function and the params
	 */
	return function feel_response_formatter(context, next) {
		debug('exec');
