...
const processInputs = (encryptedPassphrase) => ({ password, data, }) => {
    ...
    const encryptedPassphraseObject = feel_cryptography_1.parseEncryptedPassphrase(encryptedPassphraseTarget);
    const passphrase = feel_cryptography_1.decryptPassphraseWithPassword(encryptedPassphraseObject, password);
    return { passphrase };
};
