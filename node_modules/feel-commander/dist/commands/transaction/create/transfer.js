...
const feel_transactions_1 = require("@feelhq/feel-transactions");
...
const processInputs = (amount, address, data) => ({ passphrase, secondPassphrase, }) => feel_transactions_1.transfer({
    recipientId: address,
    amount,
    data,
    passphrase,
...
class TransferCommand extends base_1.default {
    async run() {
        ...
        feel_transactions_1.utils.validateAddress(address);
        const normalizedAmount = feel_transactions_1.utils.convertF39ToFellows(amount);
...
TransferCommand.args = [
    {
        name: 'amount',
        required: true,
        description: 'Amount of F39 to send.',
    },
    {
        name: 'address',
        required: true,
