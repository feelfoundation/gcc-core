...
module.exports = {
				...
				genesisConfig: {
					...
					properties: {
						EPOCH_TIME: {
							...
							format: 'date-time',
							description:
								'Timestamp indicating the start of Feel Core (`Date.toISOString()`)',
						},
						// NOTICE: BLOCK_TIME and MAX_TRANSACTIONS_PER_BLOCK are related and it's values
						// need to be changed togeter as per recommendations noted in https://github.com/feelfoundation/feel-sdk/issues/3151
						BLOCK_TIME: {
							type: 'number',
							minimum: 2,
						...
						REWARDS: {
							...
							description: 'Object representing F39 rewards milestone',
							properties: {
								MILESTONES: {
									type: 'array',
									items: {
	...
	default: {
		app: {
			...
			genesisConfig: {
				EPOCH_TIME: new Date(Date.UTC(2020, 9, 18, 10, 0, 0, 0)).toISOString(),
				BLOCK_TIME: 10,
