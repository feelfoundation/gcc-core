# Contributing to feel-newrelic

First off, thanks for taking the time to contribute! :raised_hands:

The following is a set of guidelines for contributing to feel-newrelic, which
...
[feel-newrelic Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are
...
This section guides you through submitting a bug report for feel-newrelic.
...
* **Did the problem start happening recently** (e.g. after updating to a new
	version of feel-newrelic, Feel or any other repository) or was this always a
	problem?
* If the problem started happening recently, **can you reproduce the problem in
	an older version of feel-newrelic?** What’s the most recent version in which
	the problem doesn’t happen? You can download older versions of feel-newrelic
	from [the releases page](https://github.com/feelfoundation/feel-newrelic/releases).
...
feel-newrelic, including completely new features and minor improvements to
...
* **Include screenshots and animated GIFs** which help you demonstrate the steps
	or point out the part of feel-newrelic which the suggestion is related to. You
...
* **Explain why this enhancement would be useful** to most Feel and
	feel-newrelic users.
* **Specify which version of Feel and feel-newrelic you’re using.**
...
On feel-newrelic we are using [Prettier](https://prettier.io/) and
