...
const debug = require('debug')('swagger:feel:request_limit');
 ...
 * @returns {function} {@link api.fittings.feel_request_limit}
...
module.exports = function create(fittingDef) {
	 ...
	 * @todo Add description for the function and the params
	 */
	function feel_request_limit(context, cb) {
		debug('exec');
		middleware(context.request, context.response, cb);
	}

	feel_request_limit.limits = limits;
	feel_request_limit.defaults = defaults;

	return feel_request_limit;
};
