...
const processInputs = (outputPublicKey) => ({ passphrase, password, }) => {
    ...
    const encryptedPassphraseObject = feel_cryptography_1.encryptPassphraseWithPassword(passphrase, password);
    const encryptedPassphrase = feel_cryptography_1.stringifyEncryptedPassphrase(encryptedPassphraseObject);
    return outputPublicKey
        ? {
            encryptedPassphrase,
            publicKey: feel_cryptography_1.getKeys(passphrase).publicKey,
        }
        : { encryptedPassphrase };
};
