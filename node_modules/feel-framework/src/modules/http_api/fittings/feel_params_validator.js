...
const debug = require('debug')('swagger:feel:params_validator');
 ...
 * @returns {function} {@link api.fittings.feel_params_validator}
...
module.exports = function create() {
	 ...
	 * Description of the function.
	 *
	 * @func feel_params_validator
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} cb
	 * @todo Add description for the function and the params
	 */
	return function feel_params_validator(context, cb) {
		let error = null;
