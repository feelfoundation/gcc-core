...
export declare const feelInstall: (installPath: string) => string;
export declare const installDirectory: (installPath: string, name: string) => string;
export declare const feelVersion: (version: string) => string;
export declare const feelTar: (version: string) => string;
export declare const feelTarSHA256: (version: string) => string;
export declare const feelLatestUrl: (url: string, network: NETWORK) => string;
export declare const feelSnapshotUrl: (url: string, network: NETWORK) => string;
export declare const logsDir: (installPath: string) => string;
export declare const SH_LOG_FILE = "logs/feel.out";
...
export declare const backupFeel: (installDir: string, instanceName: string) => void;
export declare const upgradeFeel: (installDir: string, name: string, network: NETWORK, currentVersion: string) => Promise<void>;
