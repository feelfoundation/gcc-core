...
const debug = require('debug')('swagger:feel:error_handler');
 ...
 * @returns {function} {@link api.fittings.feel_error_handler}
...
module.exports = function create(fittingDef) {
	 ...
	 * Description of the function.
	 *
	 * @func feel_error_handler
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} cb
	 * @todo Add description for the function and the params
	 */
	return function feel_error_handler(context, next) {
