  ...
  TransactionRequest:
    ...
    properties:
      ...
      amount:
        ...
        example: '150000000'
        description: |
          Amount of Feel to be transferred in this transaction.
      fee:
        type: string
        example: '1000000'
        description: |
      ...
      senderId:
        ...
        description: |
          Feel Address of the Senders' account.
      senderPublicKey:
        type: string
        format: publicKey
      ...
      recipientId:
        ...
        example: 12668885769632475474L
        description: |
          Feel Address of the Recipients' account.
      signature:
        type: string
        format: signature
  ...
  Block:
    ...
    properties:
      ...
      totalForged:
        ...
        example: '65000000'
        description: |
          Total amount of F39 that have been forged in this Block.
  ...
  Forger:
    ...
    properties:
      ...
      address:
        ...
        description: |
          The Feel Address is the human readable representation of the accounts owners' public key.
