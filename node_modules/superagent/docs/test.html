...
setTimeout(function() {
  ...
  .end(function(err, res) {
    ...
    res.should.have.status(200);
            ...
            <dd><pre><code>agent4
  .post('http://localhost:4500/setcookie')
  .end(function(err, res) {
    agent4
      .get('http://localhost:4500/getcookie')
      .end(function(err, res) {
        should.not.exist(err);
        res.should.have.status(200);
  ...
  .end(function(err, res) {
    ...
    res.text.should.containEql('dashboard');
            ...
            <dd><pre><code>agent1
  .post('http://localhost:4500/redirect')
  .send({ foo: 'bar', baz: 'blaaah' })
  .end(function(err, res) {
    should.not.exist(err);
    res.should.have.status(200);
    res.text.should.containEql('simple');
    res.redirects.should.eql(['http://localhost:4500/simple']);
    done();
  });</code></pre></dd>
  ...
  .end(function(err, res) {
    ...
    res.header.location.should.equal('/dashboard');
            ...
            <dd><pre><code>agent1
  .post('http://localhost:4500/signout')
  .end(function(err, res) {
    should.not.exist(err);
    res.should.have.status(200);
    should.exist(res.headers['set-cookie']);
      ...
      <dl>
        <section class="suite">
          ...
          <dl>
            ...
            <dd><pre><code>request
.get('http://localhost:5500/login', function(err, res){
  assert.strictEqual(res.statusCode, 200);
        ...
        <section class="suite">
          ...
          <dl>
            ...
            <dd><pre><code>request
.get(url.parse('http://localhost:5500/login'))
.end(function(err, res){
  assert(res.ok);
  done();
})</code></pre></dd>
...
.end(function(err, res){
  ...
  assert.equal(':5500/echo', obj.url);
...
.get('http://localhost:5500/login', function(err, res) {
    assert.equal(res.status, 200);
            ...
            <dd><pre><code>request
.post('http://localhost:5500/echo', { foo: 'bar' })
.end(function(err, res) {
  assert.equal('{&quot;foo&quot;:&quot;bar&quot;}', res.text);
            ...
            <dd><pre><code>request
.post('http://localhost:5500/echo', { foo: 'bar' }, function(err, res) {
  assert.equal('{&quot;foo&quot;:&quot;bar&quot;}', res.text);
  done();
});</code></pre></dd>
          </dl>
  ...
  assert.equal(void 0, res.header['user-agent']);
        ...
        <section class="suite">
          ...
          <dl>
            ...
            <dd><pre><code>var req = request.post('http://localhost:5500/echo');
...
.pipe(stream);</code></pre></dd>
        ...
        <section class="suite">
          ...
          <dl>
            ...
            <dd><pre><code>request
.get('http://localhost:5500/custom')
.buffer()
.end(function(err, res){
  assert.equal(null, err);
...
req.agent().should.equal(false);
        ...
        <section class="suite">
          ...
          <dl>
            ...
            <dd><pre><code>var req = request.get('http://localhost:5500/echo');
...
var req = request.get('http://localhost:5500/echo');
