...
const debug = require('debug')('swagger:feel:compression');
 ...
 * @returns {function} {@link api.fittings.feel_compression}
...
module.exports = function create(fittingDef) {
	 ...
	 * Description of the function.
	 *
	 * @func feel_compression
	 * @memberof api.fittings
	 * @param {Object} context
	 * @param {function} cb
	 * @todo Add description for the function and the params
	 */
	return function feel_compression(context, cb) {
		debug('exec');
