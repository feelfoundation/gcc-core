...
const createAccount = () => {
    ...
    const { privateKey, publicKey } = feel_cryptography_1.getKeys(passphrase);
    const address = feel_cryptography_1.getAddressFromPublicKey(publicKey);
    return {
        passphrase,
        privateKey,
        publicKey,
...
CreateCommand.description = `
		Returns a randomly-generated mnemonic passphrase with its corresponding public/private key pair and Feel address.
	`;
