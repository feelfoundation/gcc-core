...
swagger:
  ...
  bagpipes:
    _request_limit:
      name: feel_request_limit

    _cors:
      name: feel_cors

    _compression:
      name: feel_compression
      level: 9
    ...
    _json_error_handler:
      name: feel_error_handler
      handle500Errors: true

    _pre_response_cache:
      name: feel_cache
      swagger_cache_key: x-feel-cache-enabled
      mode: pre_response
